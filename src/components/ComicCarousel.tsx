                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="text-white space-y-4 md:space-y-6 order-2 lg:order-1">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-2 md:pt-4">
                        ...
                        <Link
                          href={`/comics/${comic.id}`}
                          className="inline-flex items-center justify-center px-6 md:px-8 py-2.5 md:py-3 bg-white/20 hover:bg-white/30 text-white font-semibold rounded-lg transition-colors duration-200 backdrop-blur-sm border border-white/20 text-sm md:text-base"
                        >
                          Read Comic
                        </Link>
                      </div>
